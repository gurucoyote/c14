...
re_map['indra/newview/Info-CoyoteC14.plist'] = \
...
re_map['indra/newview/English.lproj/InfoPlist.strings'] = \
    (('CFBundleShortVersionString = "Coyote C14 version [0-9.]+";',
      'CFBundleShortVersionString = "Coyote C14 version %(VER_MAJOR)s.%(VER_MINOR)s.%(VER_PATCH)s.%(VER_BUILD)s";'),
     ('CFBundleGetInfoString = "Coyote C14 version [0-9.]+',
      'CFBundleGetInfoString = "Coyote C14 version %(VER_MAJOR)s.%(VER_MINOR)s.%(VER_PATCH)s.%(VER_BUILD)s'))
