...
copy /y "c:\Program Files\fmodapi375win\api\lib\fmodvc.lib" ..\libraries\i686-win32\lib_release\
copy /y "c:\Program Files\fmodapi375win\api\lib\fmodvc.lib" ..\libraries\i686-win32\lib_debug\
