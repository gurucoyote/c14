...
static struct ft_display_info ft_display_table[] =
{
	...
	{ LLFastTimer::FTM_MOUSEHANDLER,		"  Mouse",				&LLColor4::grey2, 0 },
	{ LLFastTimer::FTM_KEYHANDLER,			"  Keyboard",			&LLColor4::grey4, 0 },
	{ LLFastTimer::FTM_SLEEP,				" Sleep & BG Threads",	&LLColor4::yellow1, 1 },
	{ LLFastTimer::FTM_FETCH,				"  Texture Fetch",		&LLColor4::yellow5, 0 },
	{ LLFastTimer::FTM_TEXTURE_CACHE,		"  Texture Cache",		&LLColor4::yellow3, 0 },
	{ LLFastTimer::FTM_DECODE,				"  Texture Decode",		&LLColor4::yellow7, 0 },
	{ LLFastTimer::FTM_VFS,					"  VFS Thread",			&LLColor4::yellow4, 0 },
	{ LLFastTimer::FTM_LFS,					"  LFS Thread",			&LLColor4::yellow6, 0 },
	{ LLFastTimer::FTM_IDLE,				" Idle",				&blue0, 0 },
	{ LLFastTimer::FTM_PUMP,				"  Pump",				&LLColor4::magenta2, 1 },
	{ LLFastTimer::FTM_ARES,				"   Ares",				&LLColor4::magenta4, 0 },
...
//	{ LLFastTimer::FTM_IDLE_CB,				"  Callbacks",			&LLColor4::pink1, 0 },
	...
	{ LLFastTimer::FTM_OCCLUSION_WAIT,		"   Occlusion Wait",	&LLColor4::red1, 0 },
	...
	{ LLFastTimer::FTM_REBUILD_MESH,		"    Rebuild Mesh Obj.",&LLColor4::yellow1, 0 },
	{ LLFastTimer::FTM_REBUILD_OCCLUSION_VB,"    Rebuild Occlusion",&LLColor4::cyan5, 0 },
