...
void LLFloaterStats::buildStats()
{
	...
	// Viewer Basic
	//
	stat_viewp = new LLStatView("basic stat view", "Basic",
								"OpenDebugStatBasic", rect);
	addStatView(stat_viewp);

	stat_barp = stat_viewp->addStat("FPS",
									&LLViewerStats::getInstance()->mFPSStat,
	...
	stat_barp = stat_viewp->addStat("Bandwidth",
									&LLViewerStats::getInstance()->mKBitStat,
									"DebugStatModeBandwidth", TRUE, FALSE);
	stat_barp->setUnitLabel(" kbps");
	stat_barp->mMinBar = 0.f;
	stat_barp->mMaxBar = 2048.f;
	stat_barp->mTickSpacing = 256.f;
	stat_barp->mLabelSpacing = 512.f;

	stat_barp = stat_viewp->addStat("Packet Loss",
									&LLViewerStats::getInstance()->mPacketsLostPercentStat,
	...
	stat_barp = stat_viewp->addStat("Ping Sim",
									&LLViewerStats::getInstance()->mSimPingStat,
									"DebugStatMode");
	...
	LLStatView *render_statviewp = stat_viewp->addStatView("render stat view",
														   "Render",
														   "OpenDebugStatRender",
														   rect);
	...
	stat_barp = render_statviewp->addStat("Total Objs",
	...
	stat_barp = render_statviewp->addStat("New Objs",
	...
	// Texture statistics
	LLStatView *texture_statviewp = render_statviewp->addStatView("texture stat view",
																  "Texture",
	...
	stat_barp = texture_statviewp->addStat("GL Mem",
	...
	stat_barp = texture_statviewp->addStat("Raw Mem",
	...
	stat_barp = texture_statviewp->addStat("Bound Mem",
	...
	stat_barp = net_statviewp->addStat("Packets In",
									   &LLViewerStats::getInstance()->mPacketsInStat,
	...
	stat_barp = net_statviewp->addStat("Packets Out",
									   &LLViewerStats::getInstance()->mPacketsOutStat,
	...
	stat_barp = net_statviewp->addStat("Objects",
									   &LLViewerStats::getInstance()->mObjectKBitStat,
	...
	stat_barp = net_statviewp->addStat("Texture",
									   &LLViewerStats::getInstance()->mTextureKBitStat,
	...
	stat_barp = net_statviewp->addStat("Asset",
									   &LLViewerStats::getInstance()->mAssetKBitStat,
									   "DebugStatModeAsset");
	stat_barp->setUnitLabel(" kbps");
	stat_barp->mMinBar = 0.f;
	stat_barp->mMaxBar = 100.f;
	...
	stat_barp = net_statviewp->addStat("Layers",
									   &LLViewerStats::getInstance()->mLayersKBitStat,
									   "DebugStatModeLayers");
	stat_barp->setUnitLabel(" kbps");
	stat_barp->mMinBar = 0.f;
	stat_barp->mMaxBar = 100.f;
	...
	stat_barp = net_statviewp->addStat("Actual In",
									   &LLViewerStats::getInstance()->mActualInKBitStat,
	...
	stat_barp = net_statviewp->addStat("Actual Out",
									   &LLViewerStats::getInstance()->mActualOutKBitStat,
	...
	stat_barp = net_statviewp->addStat("VFS Pending Ops",
									   &LLViewerStats::getInstance()->mVFSPendingOperations,
	...
	stat_barp = sim_statviewp->addStat("Time Dilation",
									   &LLViewerStats::getInstance()->mSimTimeDilation,
	...
	stat_barp = sim_statviewp->addStat("Sim FPS",
									   &LLViewerStats::getInstance()->mSimFPS,
									   "DebugStatModeSimFPS");
	stat_barp->mPrecision = 1;
	stat_barp->mMinBar = 0.f;
	...
	stat_barp = sim_statviewp->addStat("Physics FPS",
									   &LLViewerStats::getInstance()->mSimPhysicsFPS,
	...
	LLStatView *phys_details_viewp = sim_statviewp->addStatView("phys detail view",
																"Physics Details",
																"OpenDebugStatPhysicsDetails",
																rect);

	stat_barp = phys_details_viewp->addStat("Pinned Objects",
											&LLViewerStats::getInstance()->mPhysicsPinnedTasks,
	...
	stat_barp = phys_details_viewp->addStat("Low LOD Objects",
											&LLViewerStats::getInstance()->mPhysicsLODTasks,
	...
	stat_barp = phys_details_viewp->addStat("Memory Allocated",
											&LLViewerStats::getInstance()->mPhysicsMemoryAllocated,
	...
	stat_barp = sim_statviewp->addStat("Agent Updates/Sec",
									   &LLViewerStats::getInstance()->mSimAgentUPS,
	...
	stat_barp = sim_statviewp->addStat("Main Agents",
									   &LLViewerStats::getInstance()->mSimMainAgents,
	...
	stat_barp = sim_statviewp->addStat("Child Agents",
									   &LLViewerStats::getInstance()->mSimChildAgents,
	...
	stat_barp = sim_statviewp->addStat("Objects",
									   &LLViewerStats::getInstance()->mSimObjects,
	...
	stat_barp = sim_statviewp->addStat("Active Objects",
									   &LLViewerStats::getInstance()->mSimActiveObjects,
	...
	stat_barp = sim_statviewp->addStat("Active Scripts",
									   &LLViewerStats::getInstance()->mSimActiveScripts,
	...
	stat_barp = sim_statviewp->addStat("Script Events",
									   &LLViewerStats::getInstance()->mSimScriptEPS,
	...
	stat_barp = sim_statviewp->addStat("Packets In",
									   &LLViewerStats::getInstance()->mSimInPPS,
	...
	stat_barp = sim_statviewp->addStat("Packets Out", 
									   &LLViewerStats::getInstance()->mSimOutPPS,
	...
	stat_barp = sim_statviewp->addStat("Pending Downloads",
									   &LLViewerStats::getInstance()->mSimPendingDownloads,
	...
	stat_barp = sim_statviewp->addStat("Pending Uploads",
									   &LLViewerStats::getInstance()->mSimPendingUploads,
									   "SimPendingUploads");
	stat_barp->mPrecision = 0;
	stat_barp->mMinBar = 0.f;
	stat_barp->mMaxBar = 100.f;
	...
	stat_barp = sim_statviewp->addStat("Total Unacked Bytes",
									   &LLViewerStats::getInstance()->mSimTotalUnackedBytes,
	...
	LLStatView *sim_time_viewp = sim_statviewp->addStatView("sim perf view",
															"Time (ms)",
															"OpenDebugStatSimTime",
															rect);

	stat_barp = sim_time_viewp->addStat("Total Frame Time",
										&LLViewerStats::getInstance()->mSimFrameMsec,
	...
	stat_barp = sim_time_viewp->addStat("Net Time",
										&LLViewerStats::getInstance()->mSimNetMsec,
	...
	stat_barp = sim_time_viewp->addStat("Physics Time",
										&LLViewerStats::getInstance()->mSimSimPhysicsMsec,
	...
	stat_barp = sim_time_viewp->addStat("Simulation Time",
										&LLViewerStats::getInstance()->mSimSimOtherMsec,
	...
	stat_barp = sim_time_viewp->addStat("Images Time",
										&LLViewerStats::getInstance()->mSimImagesMsec,
	...
	stat_barp = sim_time_viewp->addStat("Script Time",
										&LLViewerStats::getInstance()->mSimScriptMsec,
	...
	stat_barp = sim_time_viewp->addStat("Spare Time",
										&LLViewerStats::getInstance()->mSimSpareMsec,
	...
	LLStatView *detailed_time_viewp = sim_time_viewp->addStatView("sim perf view",
																  "Time Details (ms)",
																  "OpenDebugStatSimTimeDetails",
																  rect);
	{
		stat_barp = detailed_time_viewp->addStat("  Physics Step",
												 &LLViewerStats::getInstance()->mSimSimPhysicsStepMsec,
		...
		stat_barp = detailed_time_viewp->addStat("  Update Phys. Shapes",
												 &LLViewerStats::getInstance()->mSimSimPhysicsShapeUpdateMsec,
		...
		stat_barp = detailed_time_viewp->addStat("  Physics Other",
												 &LLViewerStats::getInstance()->mSimSimPhysicsOtherMsec,
		...
		stat_barp = detailed_time_viewp->addStat("  Sleep Time",
												 &LLViewerStats::getInstance()->mSimSleepMsec,
		...
		stat_barp = detailed_time_viewp->addStat("  Pump IO",
												 &LLViewerStats::getInstance()->mSimPumpIOMsec,
