...
//	S32 joint_count = 0;
	...
	for (sj = 0; sj < mNumSkinJoints; sj++)
	{
		...
		if (mMesh->mJointRenderData.count() &&
			mMesh->mJointRenderData[mMesh->mJointRenderData.count() - 1]->mWorldMatrix == &current_joint->getParent()->getWorldMatrix())
		{
...
void LLViewerJointMesh::uploadJointMatrices()
{
	...
	for (joint_num = 0;
		 joint_num < reference_mesh->mJointRenderData.count(); joint_num++)
	{
