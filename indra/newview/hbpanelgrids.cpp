...
// static
void HBPanelGridsImpl::onInputEditorKeystroke(LLLineEditor* caller, void* data)
{
	HBPanelGridsImpl* self = (HBPanelGridsImpl*)data;
	if (self)
	{
...
//static
void HBPanelGridsImpl::onCommitCheckBoxNickname(LLUICtrl* ctrl, void* data)
{
	HBPanelGridsImpl* self = (HBPanelGridsImpl*)data;
	LLCheckBoxCtrl* check = (LLCheckBoxCtrl*)ctrl;
	if (self && check)
	{
		self->childSetValue("grid_name_editor", check->get() ? self->mGridNick
															 : self->mGridName);
	}
}
